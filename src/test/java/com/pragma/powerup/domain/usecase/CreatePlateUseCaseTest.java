...
class CreatePlateUseCaseTest {
    ...
    void shouldCreatePlateWhenValid() {
        PlateModel toCreate = new PlateModel(
                null,
                "Hamburguesa",
                15000,
                "Clásica",
    ...
    void shouldFailWhenInvalidPrice() {
        PlateModel invalid = new PlateModel(null, "A", 0, "d", "http://img", PlateCategory.ENTRADA, null, 5L);
    ...
    void shouldFailWhenRestaurantNotFound() {
        PlateModel toCreate = new PlateModel(null, "A", 10, "d", "http://img", PlateCategory.ENTRADA, null, 99L);
    ...
    void shouldFailWhenOwnerDoesNotMatch() {
        PlateModel toCreate = new PlateModel(null, "A", 10, "d", "http://img", PlateCategory.ENTRADA, null, 5L);
        when(restaurantQueryPort.findById(5L))
